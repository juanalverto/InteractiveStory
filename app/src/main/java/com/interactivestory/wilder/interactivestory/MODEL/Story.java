package com.interactivestory.wilder.interactivestory.MODEL;

import com.interactivestory.wilder.interactivestory.R;

/**
 * Created by Wilder on 12/18/14.
 */
public class Story {

    //asi se crea un array para hold Data

    private Page[] mPages;

    //Este es el constructor para inicializarla

    public Story() {

        //Aqui estoy diciendo que seran 8 arrays de Data, del 0 al 7

        mPages = new Page[7];

        //Aqui empiezan los Array desde el num 0.
        ...
        //Aqui inician los Methods por Pagina: imagen, texto, 2 deciciones a tomar en la historia etc..

        // Primero la imagen, y se va hacia su folder con el key R. que significa resources y depsues va el folder donde esta el recurso.
